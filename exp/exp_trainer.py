...
class Trainer(Exp_Basic):
    ...
    def _build_model(self):
        ...
        if self.args.need_pt:
            if self.args.use_multi_gpu and self.args.use_gpu:
                pt_model = torch.load(os.path.join(self.args.pt_dir, "/checkpoint.pth"), map_location='cpu')
            else:
                pt_model = torch.load(os.path.join(self.args.pt_dir, "/checkpoint.pth"))
